...
const DetailsBannerForms = ({ bannerId }) => {
  ...
  const updater = (e) => {
    ...
    const url = `https://7gardoon-servers.liara.run/api/updateBanners/${bannerId}`;
  ...
  const remover = () => {
    const url = `https://7gardoon-servers.liara.run/api/deleteBanners/${bannerId}`;
    axios
      .post(url)
      .then((d) => {
  ...
  useEffect(() => {
    axios
      .get(`https://7gardoon-servers.liara.run/api/banners/${bannerId}`)
      .then((d) => {
