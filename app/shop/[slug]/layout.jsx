    ...
    <div className="flex justify-between items-start container mx-auto gap-8">
      ...
      <aside className="flex flex-col gap-12 w-96 max-w-96  rounded-md  mt-20">
        <div className="flex flex-col gap-4">
          <button className="flex justify-cente items-center text-center bg-orange-500 transition-all duration-300 hover:bg-orange-600 text-white rounded-md p-2 w-full">افزودن به سبد خرید - 30000 تومان</button>
          <button className="flex justify-cente items-center text-center bg-blue-500 transition-all duration-300 hover:bg-blue-600 text-white rounded-md p-2 w-full">افزودن به علاقه مندی ها</button>
        </div>
        ...
        <div className="flex flex-col gap-4 rounded-lg p-3 shadow-[0px_0px_8px_rgba(0,0,0,0.35)]">
          ...
          <p className="text-sm text-justify leading-10 ">
            این معرفی کوتاه است این معرفی کوتاه است این معرفی کوتاه است
            این معرفی کوتاه است این معرفی کوتاه است این معرفی کوتاه است
            این معرفی کوتاه است این معرفی کوتاه است این معرفی کوتاه است
            این معرفی کوتاه است این معرفی کوتاه است این معرفی کوتاه است
          </p>
